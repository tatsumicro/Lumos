# ---------------------------------------------------------------------------
# Copyright 2017  OMRON Corporation
#
...
class TrackingAgeResult(AgeResult):
    ...
    def __str__(self):
        return AgeResult.__str__(self) + ' Status:{0}'.format(status_dic[self.tracking_status])
...
class TrackingGenderResult(GenderResult):
    ...
    def __str__(self):
        return GenderResult.__str__(self) + ' Status:{0}'.format(status_dic[self.tracking_status])
...
class TrackingRecognitionResult(RecognitionResult):
    ...
    def __str__(self):
        return RecognitionResult.__str__(self) + ' Status:{0}'.format(status_dic[self.tracking_status])
...
class TrackingResult(object):
    ...
    def __str__(self):
        ...
        return 'TrackingID:%s\tX:%s Y:%s, Size:%s Conf:%s'\
                % (t_id, x, y, size, conf)
