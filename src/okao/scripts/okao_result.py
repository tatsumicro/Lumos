...
gender_dic = {GENDER_UNKNOWN:"Unknown",\
              GENDER_FEMALE :"Female",\
              GENDER_MALE   :"Male"}

exp_dic = {EXP_UNKNOWN  :"Unknown",\
           EXP_NEUTRAL  :"Neutral",\
...
class AgeResult(object):
    ...
    def __str__(self):
        return 'Age           Age:{0} Conf:{1}'.format(self.age, self.conf)
...
class ExpressionResult(object):
    ...
    def __str__(self):
        ...
        return 'Expression    Exp:{0} Score:{1} '.format(top1_exp, top1_score)\
...
class RecognitionResult(object):
    ...
    def __str__(self):
        return 'Recognition   Uid:{0} Score:{1}'.format(self.uid, self.score)
