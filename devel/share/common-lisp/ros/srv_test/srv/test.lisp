...
(cl:defmethod cl:initialize-instance :after ((m <test-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name srv_test-srv:<test-request> is deprecated: use srv_test-srv:test-request instead.")))

(cl:ensure-generic-function 'req-val :lambda-list '(m))
(cl:defmethod req-val ((m <test-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_test-srv:req-val is deprecated.  Use srv_test-srv:req instead.")
  (req m))
...
(cl:defmethod cl:initialize-instance :after ((m <test-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name srv_test-srv:<test-response> is deprecated: use srv_test-srv:test-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <test-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_test-srv:res-val is deprecated.  Use srv_test-srv:res instead.")
  (res m))
